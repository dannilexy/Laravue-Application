    ...
    <div class="container">
        <div class="row">
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-header text-white" style="background: url('../images/pitch.jpg') center center; height: 250px; background-size: cover; --darkreader-inline-bgcolor: initial;" data-darkreader-inline-bgcolor="">
                <h3 class="widget-user-username text-right">Elizabeth Pierce</h3>
                <h5 class="widget-user-desc text-right">Web Designer</h5>
              </div>
              <div class="widget-user-image">
                <img class="img-circle" :src="getProfilePhoto()" style="height : 150px; width: 150px" alt="User Avatar">
              </div>
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control"  v-model="form.bio" id="inputExperience" placeholder="Experience"></textarea>
                            <div v-if="form.errors.has('bio')" v-html="form.errors.get('bio')"  class="text-danger"  />
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="file" class="form-control" @change="uploadPhoto" id="photo">
                        </div>
                      </div>
                      <div class="form-group row">
...
<script>
    export default {
        ...
        created() {
             this.loadProfile();
             Fire.$on('ActionDone',  () => {this.loadProfile()});
            //   Fire.$on('ActionDone',  () => {this.getProfilePhoto()})
        },
    }
</script>
